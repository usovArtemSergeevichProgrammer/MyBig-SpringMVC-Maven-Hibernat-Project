...
public class AppController {
	...
	/**
	 * This method will existing bus.
	 */
	@RequestMapping(value = { "/bus-{busUid}" }, method = RequestMethod.GET)
	public String showBus(@PathVariable String busUid, ModelMap model) {
		Bus bus = busService.findById(Integer.valueOf(busUid));
		model.addAttribute("bus", bus);
		model.addAttribute("edit", true);
		model.addAttribute("loggedinuser", getPrincipal());
		return "viewBusOfDriver";
	}

	/**
	 * This method will list all existing drivers.
	 */
	 ...
	 * This method will list all existing drivers.
	 */
	@RequestMapping(value = { "/buseslist" }, method = RequestMethod.GET)
	...
	/**
	 * This method will provide the medium to add a new Driver.
	 */
	...
	public String saveDriver(@Valid Driver driver, BindingResult result, ModelMap model) {
		...
		model.addAttribute("success",
				"Driver " + driver.getFirstName() + " " + driver.getLastName() + " registered successfully");
		model.addAttribute("loggedinuser", getPrincipal());
		// return "success";
		return "registrationsuccessDriver";
	}
	...
	public List<Bus> initializeBuses() {
