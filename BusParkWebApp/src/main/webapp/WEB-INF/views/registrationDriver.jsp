...
<body>
	<div class="generic-container">
		...
		<div class="well lead">View New Driver Form</div>
		<form:form method="POST" modelAttribute="driver"
			...
			<div class="row">
				<div class="form-group col-md-12">
					<label class="col-md-3 control-lable" for="bus">Bus</label>
					<div class="col-md-7">
						<form:select path="bus" items="${buses}" multiple="false"
							itemValue="uid" itemLabel="regNumber" class="form-control input-sm" />
						<div class="has-error">
							<form:errors path="bus" class="help-inline" />
						</div>
					</div>
				</div>
			</div>
					...
					<c:choose>
						...
						<c:otherwise>
							<input type="submit" value="Register"
								class="btn btn-primary btn-sm" /> or <a
								href="<c:url value='/driverlist' />">Cancel</a>
						</c:otherwise>
					</c:choose>
				</div>
			</div>
